---
name: "init-agentic"
description: "Scaffold Codex agentic workflow files in the current project: .Codex/mytasks/ plus docs/KNOWN_ISSUES.md, without overwriting existing content."
---
...
4. If inside a git repo, ensure `.Codex/` is ignored in `.gitignore`.
